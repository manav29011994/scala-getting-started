...
object RunKMeans {
  ...
  def main(args: Array[String]): Unit = {
    val sc = new SparkContext(new SparkConf().setAppName("runkmeans"))
    val rawData = sc.textFile("/home/manav/spark-1.1.0/smallkdd.txt")
  ...
  def visualizationInR(rawData: RDD[String]): Unit = {
    ...
    sample.saveAsTextFile("/home/manav/spark-1.1.0/kmeansresults")
